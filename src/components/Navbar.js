      ...
      <nav className="bg-white px-4 py-4 sticky top-0 z-50 shadow-md font-poppins flex items-center justify-between flex-wrap lg:px-10">
        ...
        <div className="hidden lg:flex items-center space-x-6 mx-auto" ref={dropdownRef}>
          <NavLink
            to="/"
            className={({ isActive }) =>
              `transition ${isActive ? "text-blue-800 font-semibold" : "text-gray-800 hover:text-blue-800"}`
            }
          >
            Home
          </NavLink>
          ...
          <div className="relative">
            <div
              ...
              className="flex items-center gap-1 cursor-pointer text-gray-800 hover:text-blue-800 transition"
            >
