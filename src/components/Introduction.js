...
//   return (
//     <section className="relative bg-primary-50 py-20 px-4 md:px-16 overflow-hidden">
//       {/* Main Container */}
//       <div className="relative z-10 max-w-7xl mx-auto">
//         {/* Heading */}
//         <motion.div
...
//           transition={{ duration: 0.8 }}
//         >
//           <h2 className="text-4xl font-bold bg-gradient-to-r from-primary-500 to-primary-600 text-transparent bg-clip-text font-heading">
//             Your Home's Best Friend — Zollowup
//           </h2>
//           <p className="mt-3 text-lg text-primary-600 font-roboto font-bold">
//             Our professional team can take care of all your household work – we are just one click away.
//           </p>
//         </motion.div>
...
//                 viewport={{ once: true }}
//                 transition={{ duration: 0.6, delay: 0.2 * index }}
//                 className={`rounded-xl overflow-hidden shadow-md border-2 border-primary-200 ${
...
//               transition={{ duration: 0.8 }}
//             >
//               <h3 className="text-2xl md:text-4xl font-bold bg-gradient-to-r from-primary-500 to-primary-600 text-transparent bg-clip-text font-heading leading-snug">
//                 Expert Help Exactly When<br />
//                 <span className="italic text-primary-600">You Need It..</span>
//               </h3>
//             </motion.div>
...
//               transition={{ duration: 0.8, delay: 1.1 }}
//             >
//               <div className="bg-white shadow rounded-full px-4 py-2 text-sm text-primary-600 font-semibold border-l-4 border-primary-500">
//                 ⭐ 4.9/5 Rating
//               </div>
//               <div className="bg-white shadow rounded-full px-4 py-2 text-sm text-primary-600 font-semibold border-l-4 border-primary-500">
//                 🏠 Trusted by 1K+ Homes
    ...
    <section className="bg-white py-20 px-4 md:px-16">
      <div className="max-w-5xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <img
              src="https://img.freepik.com/free-photo/young-woman-wearing-apron-rubber-gloves-holding-basin-with-cleaning-tools-with-big-smile-face-showing-thumbs-up-orange-wall_141793-13583.jpg"
          ...
          >
            {/* Headline */}
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 font-heading mb-4 leading-tight">
              Why Choose
              <br />
            ...
            {/* Description */}
            <p className="text-lg text-gray-700 font-roboto mb-8">
              We simplify home management by connecting you with trusted, verified professionals who deliver quality service every time.
            </p>
